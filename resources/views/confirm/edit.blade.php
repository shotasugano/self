    ...
    {{ csrf_field() }}
        ...
        <div class="form-group">
            <div class="col-sm-6">
                ...
                <input type="text" name="name"  class="form-control" value="{{$Citem->name}}">
                <input type="text" name="type"  class="form-control" value="{{$Citem->type}}">
                <input type="text" name="detail"  class="form-control" value="{{$Citem->detail}}">
            </div>
        </div>
